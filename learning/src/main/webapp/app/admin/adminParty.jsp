...
<body>
	...
	<main class="mng-main">
		<div class="mng-main-container">
      	...
      	<button id="reset-search-button"><a href="${pageContext.request.contextPath}/adminParty.ad">초기화</a></button>
				<div class="mng-options-search">
					<form action="${pageContext.request.contextPath}/adminParty.ad"
						method="get">
			...
			<div class="manager-ban-user-list-header-container">
				...
				<ul class="manager-ban-user-list">
					<c:choose>
						<c:when test="${not empty adminParty}">
							<c:forEach var="admin" items="${adminParty}">
		...
		<div class="mng-box-footer">
			<div id="mng-totalcount">전체 파티 게시글 수 : ${totalPartyCount}개</div>
		</div>
		<div class="pagination">
			<ul>
				...
				<c:if test="${prev}">
					<li><a
						href="${pageContext.request.contextPath}/adminParty.ad?
