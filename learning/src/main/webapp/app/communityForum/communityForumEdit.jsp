...
<body>
	...
	<div class="container">
		<c:forEach var="forumDetail" items="${forumDetail}">
			<form id="write-form"
				action="${pageContext.request.contextPath}/app/communityForum/communityForumEditEnd.cf"
	...
	<%--     <main class="communityForumEdit-main">
        <div class="communityForumEdit-main-container">
            <div class="communityForumEdit-main-container-title">
                <h1 class="communityForumEdit-main-title">파티 모집 글 수정하기</h1>
                <h3>신청자가 있다면 게시글 삭제 불가능 합니다!!</h3>
            </div>
            <form action="communityForumEditEnd.fo" method="post">
            <input type="hidden" name="postNum" value="<%= request.getParameter("postNum") %>">
                ...
                <div class="communityForumEdit-content">
                    ...
                    <div class="communityForumEdit-content-text-content" contentEditable="true"></div>
                    <input type="hidden" name="forumContent" id="hiddenForumContent">
                </div>
                <div class="communityForumEdit-file">
                    <input type="file" accept=".gif, .jpg, .png" style="display:none;" class="communityForumEdit-file-select-button" onchange="selectFile()" style="visibility:hidden">
                    <i class="icon-file-image" style="visibility:hidden"></i>
                    <p class="communityForumEdit-file-select" style="visibility:hidden"></p>
                    <button type="button" class="communityForumEdit-editCancel-button">수정취소</button>
                    <button type="submit" class="communityForumEdit-editComplete-button">수정완료</button>
                </div>
            </form>
        </div>
    </main> --%>
